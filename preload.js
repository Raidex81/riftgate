...
const INVOKABLE_CHANNELS = new Set([
    ...
    "clear-login-session",
    "clear-new-section-cache",
    "delete-community-app",
    "delete-reply",
    "delete-shared-file",
    "delete-shared-link",
    "delete-suggestion",
    ...
    "get-manga-books",
    "get-cached-manga-books",
    "get-comics-books",
    "get-cached-comics-books",
    ...
    "approve-share-access-request",
    "deny-share-access-request",
    ...
    "search-gutenberg-filtered",
    "search-openlibrary-books",
    "search-genre-books",
    "search-tv-shows",
    "search-watch-providers",
    "select-cover-image",
    ...
    "set-account-date-of-birth",
    "set-show-mature-content",
